...
def main() -> None:
    ...
    print("=" * 64)
    print("FilterAniX MTH-05 Video Processing")
    ...
    try:
        ...
        while True:
            ...
            mth02 = color_engine.transform(
                rgb
            )

            mth03 = tone_engine.transform(
                mth02.output_rgb
            )
            ...
            if frame_index % 24 == 0 or frame_index == 1:
                ...
                print(
                    f"Rendered {frame_index}{total_str} frames..."
                )
